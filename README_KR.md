...
| 제어기 (Controller) | 🌙 달 ($1.62\,\text{m/s}^2$) | 🔴 화성 ($3.72\,\text{m/s}^2$) | 🌍 지구 ($9.81\,\text{m/s}^2$) | 🪐 목성 ($24.79\,\text{m/s}^2$) | 평균 각도 오차 ($\overline{|\theta|}$) |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Trained PPO (20K)** | **500.0** (100%) | **500.0** (100%) | **500.0** (100%) | **500.0** (100%) | $0.26^\circ$ (지구) / $0.53^\circ$ (목성) |
| **Optimal LQR (Riccati)** | **500.0** (100%) | **500.0** (100%) | **500.0** (100%) | **500.0** (100%) | $0.18^\circ$ (지구) / $0.42^\circ$ (목성) |
| **Undercooked PPO (2K)** | 21.7 (0%) | 21.7 (0%) | 19.3 (0%) | 18.6 (0%) | N/A (학습 미완료 조기 추락) |

### 🌪️ 2. 환경 스트레스 & 강인성 벤치마크 (지구 중력 $9.81\,\text{m/s}^2$)
| 제어기 (Controller) | 표준 무외란 (Clean) | 지속 풍압 ($+2.2\,\text{N}$) | 센서 노이즈 ($\sigma=0.05$) | 복합 스트레스 환경 |
| :--- | :---: | :---: | :---: | :---: |
